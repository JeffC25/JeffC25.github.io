const Navbar = () => {
    return (
        <nav className="w-3/4 h-16 flex flex-row text-lg text-neutral-900 items-center justify-center rounded-full shadow-md backdrop-blur-md bg-neutral-200/50 px-8">
