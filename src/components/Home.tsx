const Home = () => {
    return (
        <div id="home" className="h-full snap-start flex flex-col sm:flex-row justify-center items-center space-x-20">
            <div className="h-1/2 w-64  flex flex-col justify-center space-y-12">
            ...
            <div className="">
                ...
                <p className="h-1/2 sm:w-1/3 text-lg">
                    Sample text
                </p>
            </div>
        </div>
